...
def generate_launch_description() -> LaunchDescription:
        ...
        parameters=[
            {
                ...
                'io_debug': LaunchConfiguration('io_debug'),
        ...
        parameters=[
            {
                ...
                'enable_action_smoothing': LaunchConfiguration('enable_action_smoothing'),
                'smoothing_window_frames': LaunchConfiguration('smoothing_window_frames'),
            }
        ],
    )
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument('enable_action_smoothing', default_value='true'),
            DeclareLaunchArgument('smoothing_window_frames', default_value='5'),
